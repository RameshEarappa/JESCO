report 50111 "Jesco Purchase - Receipt"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\Layout Reports Rdls\JescoJescoPurchaseReceipt.rdl';
    Caption = 'Jesco Purchase - Receipt';
    ...
    dataset
    {
        dataitem("Purch. Rcpt. Header"; "Purch. Rcpt. Header")
        {
            ...
            column(PurchReceiptLbl; PurchReceiptLbl)
            {
            }
    ...
    var
        PurchReceiptLbl: Label 'Purchase Receipt';
